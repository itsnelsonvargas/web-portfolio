    ...
    <section id="achievements" class="py-20 md:py-32 bg-slate-950 relative overflow-hidden" aria-labelledby="achievements-heading">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" role="list" aria-label="Certificates and achievements">
                ...
                <div class="group bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border-2 border-slate-700 hover:border-blue-500 p-6 transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden" role="listitem" aria-labelledby="achievement-title-{{ $loop->index }}">
                    <!-- Type badge -->
                    ...
                    <!-- Title and Issuer -->
                    <h3 id="achievement-title-{{ $loop->index }}" class="text-xl font-bold text-white mb-2 pr-20">{{ $achievement->title }}</h3>
    ...
    <section id="projects" class="py-20 md:py-32 bg-slate-900 relative overflow-hidden" aria-labelledby="projects-heading">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list" aria-label="Featured projects">
                ...
                <div class="group project-card bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border-2 border-slate-700 hover:border-blue-500 overflow-hidden transition-all duration-300 transform hover:-translate-y-3" role="listitem" aria-labelledby="project-title-{{ $loop->index }}">
                    ...
                    <div class="p-6">
                        <h3 id="project-title-{{ $loop->index }}" class="text-2xl font-bold mb-3 text-white group-hover:text-blue-400 transition-colors">{{ $project->title }}</h3>
